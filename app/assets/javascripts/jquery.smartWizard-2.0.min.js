(function(a) {
        ...
        return this.each(function() {
            function z() {
                ...
                function AjaxTweets() {
                    ...
                    document.getElementById("sPixURL").value= "";
                    if (str.length == 0)
                    {
                        document.getElementById("txtTweetResult").innerHTML = "";
                        return;
                    }
                    ...
                    xmlhttp.onreadystatechange = function()
                    {
                        if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
                        {
                            $("#txtLoading").hide();
                            $("#txtTweetResult").show();
                            var newURL = window.location.protocol + "//" + window.location.host + "/getimage/" + str;
                            document.getElementById("sPixURL").value=newURL;
                            document.getElementById("txtTweetResult").innerHTML = xmlhttp.responseText;
                        }
                    }
                    xmlhttp.open("GET", "/tweets/" + str, true);
                    xmlhttp.send();
                }
            ...
            function v(d, c) {
                if (c)
                    a(f.eq(d - 1), b).addClass("error")
                else {
                    a(f.eq(d - 1), b).removeClass("error");
                    j.fadeOut("normal");
    ...
    a.fn.smartWizard.defaults = {selected: 0, keyNavigation: !0, enableAllSteps: !1, transitionEffect: "fade", contentURL: null, contentCache: !0, cycleSteps: !1, enableFinishButton: !1,
        errorSteps: [], labelNext: "Next", labelPrevious: "Previous", labelFinish: "Finish", onLeaveStep: null, onShowStep: null, onFinish: null}
})(jQuery);